...
>>>>- Total Sales Revenue: $203,163,494. The market shows a steady upward trend from January through May, indicating strong consumer demand.

>>>>- Actual Return Rate: 0.09%. While low, the "Actual" rate is used as a baseline to identify outliers.

>>>>- Avg Market Share: 2.85%. This metric helps identify "Category Dominance," where top vendors significantly outperform the mean.
